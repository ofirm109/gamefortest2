...
function stopGame() {
    if (stop == false) {
        $("#playWindow").show();
        stop = true;
        $("#stopGame").css("background-image", "url(https://raw.githubusercontent.com/ofirm109/gg1/master/image/play-05.png)");
    } else {
        $("#playWindow").hide();
        stop = false;
        $("#stopGame").css("background-image", "url(https://raw.githubusercontent.com/ofirm109/gg1/master/image/stop-04.png)");
    }
